...
This is the configuration file that sets up the test suite for PHPUnit and tells it which tests need to execute. This file must be placed in the same directory as the other tests.

<phpunit>
	<testsuites>
		<testsuite name="Twitter Data Design">
